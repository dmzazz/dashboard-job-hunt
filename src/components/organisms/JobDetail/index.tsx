        ...
        <div className="col-span-2 space-y-10">
          <div>
            ...
            <div className="text-gray-500 mt-3">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque accusantium enim quod, explicabo in vitae nisi omnis sequi architecto. Eius voluptatibus obcaecati aliquam, commodi dolores quas alias numquam non praesentium?
              </p>
            </div>
          </div>
          <div>
